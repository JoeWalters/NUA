...
export default function Navbar({ themeValue, callBackChanged, onSettingsClick, onLogout, showLogout, onHealthToggle }) {
  ...
  // Shared controls (sync dot, theme toggle, settings, logout). Rendered inline
  // on md+ screens and inside a dropdown on small screens so the navbar stays compact.
  const controls = (
    <>
      <button
  ...
  return (
    <div className="navbar bg-base-100 border-b border-base-200 px-4 z-50">
      ...
      {/* Right: controls inline on md+ screens */}
      <div className="hidden md:flex items-center gap-3">
        {controls}
      </div>

      {/* Right: controls in a dropdown on small screens */}
      <div className="dropdown dropdown-end md:hidden">
        ...
        <div
          tabIndex={0}
          className="dropdown-content bg-base-100 rounded-box z-50 w-56 p-3 shadow border border-base-300"
        >
